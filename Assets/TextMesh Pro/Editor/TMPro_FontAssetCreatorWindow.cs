    ...
    public class TMPro_FontAssetCreatorWindow : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            if (EditorGUIUtility.isProSkin)
            {
                ...
                progressTexture = AssetDatabase.LoadAssetAtPath("Assets/TextMesh Pro/GUISkins/Textures/Progress Bar.psd", typeof(Texture2D)) as Texture2D;
            }
            else
            {
                mySkin = AssetDatabase.LoadAssetAtPath("Assets/TextMesh Pro/GUISkins/TMPro_LightSkin.guiskin", typeof(GUISkin)) as GUISkin;
                progressTexture = AssetDatabase.LoadAssetAtPath("Assets/TextMesh Pro/GUISkins/Textures/Progress Bar (Light).psd", typeof(Texture2D)) as Texture2D;
            }
            ...
            {               
                FileUtil.ReplaceFile(projectPath + "/Assets/TextMesh Pro/Plugins/TMPro_Plugin.dll", projectPath + "/TMPro_Plugin.dll"); // Copy the .dll
                FileUtil.ReplaceFile(projectPath + "/Assets/TextMesh Pro/Plugins/TMPro_Plugin.dylib", projectPath + "/TMPro_Plugin.dylib"); // Copy Mac .dylib
                FileUtil.ReplaceFile(projectPath + "/Assets/TextMesh Pro/Plugins/vcomp120.dll", projectPath + "/vcomp120.dll"); // Copy OpemMP .dll                 
            }                   
