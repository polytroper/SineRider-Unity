...
public class Benchmark04 : MonoBehaviour 
{
    ...
    void Start()
    {
        ...
        float lineHeight = 0;
        float orthoSize = Camera.main.orthographicSize = Screen.height / 20;
        ...
        for (int i = MinPointSize; i <= MaxPointSize ; i += Steps)
        {
            ...
            { 
                ...
                go.transform.position = new Vector3( ratio * -orthoSize * 0.975f + transform.position.x, orthoSize * 0.975f - lineHeight, 1);              
